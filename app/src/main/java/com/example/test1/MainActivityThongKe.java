...
public class MainActivityThongKe extends AppCompatActivity {
    ...
    TextView TongTien, hoaDon, sanPham;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hoaDon = findViewById(R.id.TongHoaDon);
        sanPham = findViewById(R.id.TongSanPham);
        Loading();
    }
...
//            Toast.makeText(this, ""+cursor.getString(5), Toast.LENGTH_SHORT).show();
            ...
            TongSanPham += cursor.getInt(4);
            hoaDon.setText("" + hoaDonAdapter.getCount());
        }
